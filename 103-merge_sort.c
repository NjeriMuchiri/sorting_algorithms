...
/**
 * mersort - secondary function for
 * Merge sort algorithm
 * @array: array
 * @low: low index
 * @high: high index
...
{
midle = (low + high - 1) / 2;
mersort(array, low, midle, buffer);
mersort(array, midle + 1, high, buffer);
