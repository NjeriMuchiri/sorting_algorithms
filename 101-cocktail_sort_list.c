#include "sort.h"
/**
 * swaps_list - function that swaps the lists' elements
 * @ptr1: first pointer
 * @ptr2: second pointer
...
/**
 * increase_sorting - function that moves the bigger numbers to the end
...
/**
 * decrease_sorting - function that moves the smaller numbers to the start
...
ptr = *list;
do {
increase_sorting(&ptr, &limit1, list);
decrease_sorting(&ptr, &limit2, list);
} while (limit1 != limit2);
}
